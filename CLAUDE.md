...
- **69 migrazioni** registrate in `applied_migrations` (le ultime del 12/08: `haccp_alla_porta`, `memoria_articoli`, `carico_con_memoria`, `ogni_rincaro_si_vede`). Verificato in produzione dopo ognuna, dal connettore in sola lettura.
