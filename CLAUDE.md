...
**Chiuso di recente:**
- **Chiedi all'archivio (12/08) — COSTRUITO, non ancora provato dal vivo** — l'assistente che risponde a domande sui documenti archiviati, usando `documents.testo` che la consegna precedente aveva predisposto senza usarlo. Migrazione `20260812000009`, funzione online `assistente-archivio`, schermata `/documenti/chiedi`, 5 prove automatiche nuove. **Diventa «fatto» quando Alessio fa una domanda vera e la risposta cita il documento giusto.**
...
- 🔄 **Chiedi all'archivio** — costruito il 12/08 (vedi «Chiuso di recente»). **Chiuso quando** Alessio applica la migrazione, installa la funzione online e fa una domanda vera che cita il documento giusto.
