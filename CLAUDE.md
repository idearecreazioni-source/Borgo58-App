...
- **Dominio: cosa resta** — a registrazione completata (`.it` in corso la notte dell'11/08): creare `info@borgo58.it`, collegarla alla Gmail del locale per rispondere con l'indirizzo giusto, puntare il dominio al sito su Cloudflare **senza perdere i record MX di Aruba**, e costruire l'email automatica di conferma al cliente (Resend)
