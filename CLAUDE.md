...
- **65 migrazioni** registrate in `applied_migrations` (le ultime del 12/08: `chiedi_all_archivio`, `indice_pronto_archivio`, `carico_da_fattura`). Verificato in produzione dopo ognuna, dal connettore in sola lettura.
