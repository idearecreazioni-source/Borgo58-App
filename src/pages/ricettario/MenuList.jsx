          ...
          {menus.map((m) => (
            ...
            >
              <div className="flex items-start justify-between gap-2">
                <h3 className="font-display text-base text-b58-charcoal">{m.name}</h3>
                {m.is_active && (
                  <span className="text-[10px] font-medium uppercase tracking-wide bg-b58-olive text-b58-parchment rounded-full px-2 py-1 shrink-0">
                    Attivo
                  </span>
                )}
              </div>
