...
export default function RicettarioHome() {
  ...
  return (
    <div className="max-w-4xl mx-auto testo-sala-grande">
      <div className="mb-8">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
        {isTitolare && (
          ...
          >
            ...
            <h3 className="font-display testo-sala-grande text-b58-charcoal">Ingredienti</h3>
        ...
        >
          ...
          <h3 className="font-display testo-sala-grande text-b58-charcoal">Ricette</h3>
          <p className="testo-sala-grande text-b58-charcoal-soft mt-1">
            {isTitolare
