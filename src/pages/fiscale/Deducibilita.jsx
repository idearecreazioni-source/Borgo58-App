  ...
  return (
    <div className="max-w-5xl mx-auto pb-16">
      ...
      <div className="rounded-xl bg-b58-parchment ring-1 ring-b58-charcoal/10 p-6 mb-6">
        <h2 className="font-display testo-sala-titolo text-b58-charcoal mb-1">I costi del {anno}</h2>
        ...
        {loading ? (
          ...
          <p className="testo-sala-grande text-b58-charcoal-soft/60">Nessun dato.</p>
        ) : (
          <>
            ...
            <p className="testo-sala text-b58-charcoal-soft bg-white/70 rounded-lg px-3 py-2 ring-1 ring-b58-charcoal/10">
              ...
              <tbody>
                {daClassificare.map((c) => (
                  <tr key={`${c.origine}-${c.riga_id}`} className="border-b border-b58-charcoal/5 last:border-0">
                    ...
                    <td className="py-2 testo-sala text-b58-charcoal-soft">{c.motivo}</td>
                  </tr>
                ))}
              </tbody>
            </table>
      ...
      <div className="rounded-xl bg-b58-parchment ring-1 ring-b58-charcoal/10 p-6">
        <h2 className="font-display testo-sala-titolo text-b58-charcoal mb-1">Le regole</h2>
        <p className="testo-sala text-b58-charcoal-soft/70 mb-4">
          ...
          <table className="w-full testo-sala-grande">
            ...
            <tbody>
              {regole.map((r) => (
                ...
                >
                  <td className="py-2 text-b58-charcoal font-medium">
                    {r.etichetta}
                    {r.nota && (
                      <div className="testo-sala font-normal text-b58-charcoal-soft/80 mt-0.5 max-w-md">
                        {r.nota}
                      </div>
                    )}
                  </td>
              ...
              {regole.length === 0 && !loading && (
                <tr>
                  <td colSpan={5} className="py-3 testo-sala-grande text-b58-charcoal-soft/60">
                    Nessuna regola.
                  </td>
                </tr>
              )}
        ...
        <div className="bg-white rounded-lg border border-b58-charcoal/10 p-4">
          <h3 className="testo-sala font-medium uppercase tracking-wide text-b58-charcoal-soft mb-3">
            Nuova regola
          </h3>
...
function Riquadro({ etichetta, valore, nota, allarme }) {
  return (
    ...
    >
      ...
      <div className={`testo-sala-titolo ${allarme ? "text-b58-gold-dark" : "text-b58-charcoal"}`}>
        {formatEUR(valore)}
      </div>
      {nota && <div className="testo-sala text-b58-charcoal-soft/70 mt-0.5">{nota}</div>}
    </div>
  );
}
