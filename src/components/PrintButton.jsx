...
export default function PrintButton({ label = "Esporta PDF" }) {
  return (
    <button
      ...
      className="print:hidden rounded-lg border border-b58-charcoal/15 hover:bg-b58-cream-dark transition-colors text-b58-charcoal text-sm font-medium px-4 py-2"
    >
      {label}
    </button>
  );
